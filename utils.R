...
# PLOT FUNCTIONS
# ==========================================
funnel_plot <- function(data, base = 11, wrap = 40, log_x = FALSE, zebra = TRUE, over_dispersion = 3, sigmas = seq(0.5, 5.0, by = 0.5)) {
  ...
  if (nrow(plot_data) == 0) return(ggplot() + theme_minimal())
