...
glanceUI <- function(id,
  ...
  nav_panel(
    ...
    card(
      ...
      card_body(
        ...
        tags$p(
          ...
          "This section displays the total monthly acute emergency admissions via type-1 A&E departments per provider for the latest reporting period (",
        ...
        tags$p(
          ...
          tags$sup("§"),
          ". This metric calculates the net number of patients admitted within 4 hours compared to what would be expected under average national performance (where positive values indicate delays prevented/timely admissions, and negative values indicate excess delays)."
        )
      )
    ),
    ...
    navset_card_tab(
      ...
      nav_panel(title = "Latest Monthly A&E Admission Data", card_body(
        class = "content-card-body", div(
      ...
      nav_panel(title = "3-Month Admission Time Performance vs National", card_body(
        class = "content-card-body", div(
          class = "content-table-scroll",
          withSpinner(
...
glanceServer <- function(id) {
  moduleServer(id, function(input, output, session) {
    ...
    output$overview_table <- renderReactable({
      ...
      clean_pcts <- clean_pcts[!is.na(clean_pcts) &
                                 !is.nan(clean_pcts)]
        ...
        columns = list(
          ...
          `Estimated deaths per thousand admissions` = colDef(
            ...
            cell = function(value, index) {
              ...
              tags$span(style = list(fontWeight = if (is_total)
                "bold"
                else
                  "normal"),
                display_text)
          ...
          Trend = colDef(
            ...
            cell = function(value, index) {
              ...
              tags$span(style = list(
                color = text_color,
                fontWeight = if (is_total)
                  "bold"
                else
                  "normal"
              ),
    ...
    output$perf_3month <- renderReactable({
      ...
      reactable(
        ...
        theme = reactableTheme(cellPadding = "16px 12px"),
        ...
        columns = list(
          ...
          # The custom "Trust vs National" Gap Visual Column
          Visual = colDef(
              ...
              div(
                ...
                div(
                  ...
                  if (!is_total) {
                    ...
                    gap_color <- if (est_pct < global_pct)
                      POS_CLR_LGT
                    else
                      NEG_CLR_LGT
                  ...
                  # 3. Trust Value Label (Above dot, formatted to 0 decimals)
                  div(
                    style = sprintf(
                  ...
                  # 4. National Tick Mark (Reference Line)
                  if (!is_total) {
                    div(
                      style = sprintf(
                  ...
                  # 5. National Label (Below line, formatted to 0 decimals)
                  if (!is_total) {
                    div(
                      style = sprintf(
          ...
          net_timely = colDef(
            ...
            cell = function(value, index) {
              ...
              div(style = list(color = color, fontWeight = "bold"),
                  formatted_val)
            }
          )
        )
